...
/**
 * This is the third simple BDD example. This one discusses
 * sets, functions, permutations and relation products and more
 */
...
public class Simple3 {
	...
	Permutation perm = bdd.createPermutation( new int [] { v0p, v1p},
						 new int [] { v0, v1}); // vn' -> vn
